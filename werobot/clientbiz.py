...
class Client(object):
    ...
    """
    def __init__(self, corpid, agentid, appsecret):
        self.corpid = corpid
    ...
    def send_image_message(self, user_id="", party_id="", tag_id="", media_id=None):
        """
        发送图片消息
    ...
    def send_voice_message(self, user_id="", party_id="", tag_id="", media_id=None):
        """
        发送语音消息
        详情请参考 http://mp.weixin.qq.com/wiki/index.php?title=发送客服消息
